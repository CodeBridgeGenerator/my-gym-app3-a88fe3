...
import seederData from "./membershiplans.seeder.json";
...
const MembershiplansSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MembershiplansSeederDialogComponent);
