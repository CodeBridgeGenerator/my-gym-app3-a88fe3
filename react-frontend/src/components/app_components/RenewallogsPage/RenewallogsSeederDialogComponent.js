...
import seederData from "./renewallogs.seeder.json";
...
const RenewallogsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(RenewallogsSeederDialogComponent);
